    ...
    public void onGameInit(GameInitializationEvent event) {
        ...
        CommandSpec commandman = CommandSpec.builder()
                ...
                .executor((CommandSource src, CommandContext args) -> {
                    ...
                    player.sendMessage(Text.of(TextColors.LIGHT_PURPLE, src.getName(), " hugs you."));
        ...
        CommandSpec commandman7 = CommandSpec.builder()
                ...
                .executor((CommandSource src, CommandContext args) -> {
                    ...
                    if (src.hasPermission("addplot.use")) {
                        if (player.hasPermission("plots.plot.12")){
                            player.sendMessage(Text.of(TextColors.RED, "You already have the max amount of plots. (12)"));
                        }else if (player.hasPermission("plots.plot.11")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.12");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 12 total plots."));
                        }else if (player.hasPermission("plots.plot.10")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.11");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 11 total plots."));
                        }else if (player.hasPermission("plots.plot.9")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.10");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 10 total plots."));
                        }else if (player.hasPermission("plots.plot.8")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.9");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 9 total plots."));
                        }else if (player.hasPermission("plots.plot.7")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.8");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 8 total plots."));
                        }else if (player.hasPermission("plots.plot.6")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.7");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 7 total plots."));
                        }else if (player.hasPermission("plots.plot.5")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.6");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 6 total plots."));
                        }else if (player.hasPermission("plots.plot.4")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.5");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 5 total plots."));
                        }else if (player.hasPermission("plots.plot.3")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.4");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 4 total plots."));
                        }else if(player.hasPermission("plots.plot.2")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.3");
                            player.sendMessage(Text.of(TextColors.AQUA, "You can now have 3 total plots."));
                        }else if(player.hasPermission("plots.plot.1")){
                            Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + getPlayerName + " permission set plots.plot.2");
